      ...
      <div className='relative z-10'>
        ...
        <div className='absolute top-4 left-4 text-left'>
          <h1 className='text-5xl font-extrabold'>
           Hi! I'm 
            <br></br><span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>{"Sunanda N"}</span>
          </h1>
          <p className='mt-4 text-left text-2xl max-w-xl mx-auto'>    Welcome to my portfolio! I am passionate about science and technology. Explore my work and feel free to get in touch.</p>
        </div>
